...
public class Mod_Loot_Summary {
    ...
    public Mod_Loot_Summary(String created, String status, String count_Get_Receive, String count_Get_Bank, String count_Get_Mshwari, String count_Get_from_NCBA, String count_Get_from_IM, String count_Get_Bal, String count_Get_Bal_KCB, String count_Get_Bal_Mshwari, String count_Get_Reversal, String count_Loan_Limit, String count_Sent, String count_Sent_Mini, String count_Sent_Mshwari, String count_Sent_Cancel, String count_Error_Failed, String count_Error_Pay_Merchant, String count_Error_Pin, String count_Error_Less, String count_Error_Receiver, String count_Error_Receiver_Org, String count_Withdraw, String count_Fuliza_Leave, String count_Fuliza_Opt_In, String count_Fuliza_Limit, String count_Fuliza_Mini_Statement, String count_Fuliza_Loan_Taken, String count_Similar_Transaction, String count_All, String count_Unknown) {
        ...
        this.count_Fuliza_Leave = count_Fuliza_Leave;
    ...
    public String getCount_Get_Receive() {
        return count_Get_Receive;
    }

    public void setCount_Get_Receive(String count_Get_Receive) {
        this.count_Get_Receive = count_Get_Receive;
    }

    public String getCount_Get_Bank() {
        return count_Get_Bank;
    }

    public void setCount_Get_Bank(String count_Get_Bank) {
        this.count_Get_Bank = count_Get_Bank;
    }

    public String getCount_Get_Mshwari() {
        return count_Get_Mshwari;
    }

    public void setCount_Get_Mshwari(String count_Get_Mshwari) {
        this.count_Get_Mshwari = count_Get_Mshwari;
    }
    ...
    public String getCount_Get_Bal() {
        return count_Get_Bal;
    }

    public void setCount_Get_Bal(String count_Get_Bal) {
        this.count_Get_Bal = count_Get_Bal;
    }
    ...
    public String getCount_Get_Reversal() {
        return count_Get_Reversal;
    }

    public void setCount_Get_Reversal(String count_Get_Reversal) {
        this.count_Get_Reversal = count_Get_Reversal;
    }
    ...
    public void setCount_Sent(String count_Sent) {
        this.count_Sent = count_Sent;
    }
    ...
    public String getCount_Sent_Mshwari() {
        return count_Sent_Mshwari;
    }

    public void setCount_Sent_Mshwari(String count_Sent_Mshwari) {
        this.count_Sent_Mshwari = count_Sent_Mshwari;
    }
    ...
    public String getCount_Error_Pay_Merchant() {
        return count_Error_Pay_Merchant;
    }

    public void setCount_Error_Pay_Merchant(String count_Error_Pay_Merchant) {
        this.count_Error_Pay_Merchant = count_Error_Pay_Merchant;
    }
    ...
    public String getCount_Fuliza_Leave() {
        return count_Fuliza_Leave;
    }

    public void setCount_Fuliza_Leave(String count_Fuliza_Leave) {
        this.count_Fuliza_Leave = count_Fuliza_Leave;
    }
            ...
            case "Get from NCBA":
             ...
             case "Get Reversal":
              ...
              case "Similar Transaction":
                return count_Similar_Transaction;//count_Unknown
              case "Unknown":
                return count_Unknown;//count_Unknown
            default:
                return count_All;
        }
    }
