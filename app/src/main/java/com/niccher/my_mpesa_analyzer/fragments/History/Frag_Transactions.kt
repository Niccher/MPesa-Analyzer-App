...
import com.niccher.my_mpesa_analyzer.adapter.Adapter_Transactions
import com.niccher.my_mpesa_analyzer.models.Mod_Transaction
...
class Frag_Transactions : Fragment() {

    private lateinit var recyclerView: RecyclerView
    private lateinit var adapter: Adapter_Transactions
    ...
    private fun loadTransactions() {
        ...
        lifecycleScope.launch {
            ...
            val transactions = withContext(Dispatchers.IO) {
                val list = ArrayList<Mod_Transaction>()
    ...
    private fun parseMpesaSms(trans: Mod_Transaction) {
        val b = trans.body
        when {
